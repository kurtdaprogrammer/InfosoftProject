...
namespace InfosoftProject
{
    class Lessons
    {
        ...
        public void InputOutput_l3()
        {
            ...
            Console.WriteLine("I am working in " + Company);
        ...
        public void SwitchStatements_l6()
        {
            ...
            Console.WriteLine("Enter Numeral Month: ");
            month = Convert.ToInt32(Console.ReadLine());

            Console.WriteLine("Enter Numeral Date: ");
        ...
        public void Array_l8()
        {
            ...
            string[] Password = {
                "kurtdade","migueljimenez","karlpaclar"
            };
